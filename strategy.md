...
**Last updated: 2026-08-16** (initial version — restructured from agents.md notes + live league state)
...
- **Draft 1.9: take Makai Lemon (WR-PHI)** if he survives picks 1.7/1.8. Fallbacks: Omar Cooper (WR-NYJ), then De'Zhaun Stribling. Never QB or TE — massively overstocked at both. Rounds 2–3: best available young WR/RB by landing spot.
...
- **Pick 1.9 board (Matt-confirmed, execute without asking):** 1) Makai Lemon (WR-PHI) — full KTC tier above alternatives (~4,950 vs ~3,400), hamstring risk priced in; 2) Omar Cooper (WR-NYJ) — healthy, edges Stribling on age; 3) De'Zhaun Stribling (WR).
